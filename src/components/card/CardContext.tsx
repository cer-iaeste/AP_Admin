...
interface CardContextType {
    countryName: string
    handleSave: (country: string, data: any, column: keyof CountryType, title: string, isCardObject?: boolean) => void
    ...
    handleCancel: (setData: (data?: any) => void, data?: any, isCardObject?: boolean) => Promise<boolean>
